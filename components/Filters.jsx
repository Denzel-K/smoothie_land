...
const FilterButton = ({ title, btnStyles, onPress, isActive }) => {
  return (
    <TouchableOpacity
      activeOpacity={0.8}
      className={`flex items-center justify-center align-middle border-[1.5px] rounded-3xl px-[12px] py-[4px] mr-2 ${
...
const Filters = ({ onFilterChange }) => {
  ...
  return (
    <View className="flex flex-col align-middle justify-center items-center mt-2 bg-gray-900 p-2 rounded-xl">
      ...
      {!inactive && (
        <View className="flex w-full mt-2 bg-gray-950 rounded-lg pl-[12px] pr-[4px]">
